...
<style>
  ...
  .detalhe-item:last-child { border-bottom: 0; }
    ...
    <div class="container">
      <div class="resultado-grid">
        <div class="resultado-info">
          ...
          <p class="lead">Fale com um de nossos especialistas e consulte a possibilidade de compor sua renda e aplicar subsídios de programas estaduais e federais.</p>
          ...
          <div class="corretor-actions">
            ...
            <a href="https://wa.me/5584994618126?text=Ol%C3%A1!%20Vim%20pelo%20site%20da%20Castel%20e%20gostaria%20de%20mais%20informa%C3%A7%C3%B5es." class="btn red" target="_blank" rel="noopener">Falar pelo WhatsApp</a>
          </div>
        </div>
        ...
        <div class="resultado-card">
          ...
          <div class="resultado-detalhes">
            <p class="muted small">Na Tabela Price, as parcelas são todas iguais, de valor fixo, da primeira à última.</p>

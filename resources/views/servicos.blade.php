...
<style>
  ...
  .form-group label { display: block; margin-bottom: .5rem; font-weight: 500; color: var(--text-color-light); }
  .form-group input, .form-group textarea { width: 100%; padding: .75rem 1rem; border: 1px solid #ddd; border-radius: var(--radius-sm, 6px); background-color: #f9f9f9; font-size: 1rem; color: var(--text-color); transition: border-color .2s, box-shadow .2s; }
  .form-group input:focus, .form-group textarea:focus { outline: none; border-color: var(--brand-blue); box-shadow: 0 0 0 3px rgba(18, 29, 49, 0.1); }
  .form-group input[readonly] { background-color: #eee; font-weight: 500; color: var(--brand-blue); }
    ...
    <div class="card" style="padding: 2rem;">
      ...
      <form id="orcamento-form">
        ...
        <div class="form-group">
          ...
          <textarea id="mensagem" name="mensagem" rows="5" placeholder="Forneça mais detalhes sobre sua necessidade..."></textarea>
        </div>
        <div class="actions">

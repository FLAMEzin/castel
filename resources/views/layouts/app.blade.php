...
<head>
  ...
  <meta name="description"
    content="@yield('description', 'Construtora Castel — empreendimentos com qualidade e seriedade no RN.')" />
...
<body>
  ...
  <header class="header" role="banner">
    ...
    <div class="container navbar" role="navigation" aria-label="Principal">
      <a class="brand" href="/index" aria-label="Castel - Início"><img src="/img/Logo.png" width="150"
          alt="Castel Logo" /></a>
    ...
    <div class="container">
      <div class="grid">
        ...
        <div>
          ...
          <p><a href="/sobre">Sobre Nós</a><br /><a href="/empreendimentos">Empreendimentos</a><br /><a
              href="/reservas">Reservas</a><br /><a href="/servicos">Serviços</a><br /><a href="/contato">Contato</a>
          </p>
        </div>
      </div>
      <div class="subfooter">© <span id="year"></span> Castel Construções e Incorporações — Todos os direitos
        reservados.</div>
    </div>
  </footer>
